...
\begin{section}{Teaching Experience}
    ...
    \item Coached teams going to ICPC World Finals in GoForGold Winter Camp 2024, New Delhi, India
    \item Coached students going to the IOI in GoForGold IOI Camp 2025, Online
    \item Coached teams going to ICPC World Finals in GoForGold Summer Camp 2025, Pune, India
    \end{subsectionnobullet}

    \begin{subsectionnobullet}{Saudi Arabian IOI Training Camp}{Trained the Saudi team for the IOI}{2026}{Jeddah, Saudi Arabia}
    \end{subsectionnobullet}
  ...
  \begin{subsection}{Iran National Olympiad of Informatics (INOI)}{The INOI Summer Camp is the final stage of the INOI program, where students undergo intensive training and take final exams to determine medalists. The camp spans two months.}{2019 - Present}{Tehran, Iran}
    \item \textbf{Summer Camp Director} – INOI Summer Camp (2024, 2025)
  ...
  \begin{subsectionnobullet}{Sharif University of Technology}{Lecturer}{2026}{Tehran, Iran}
